 ...
 * Slug: capsule/mbf-product-carousel
...
<!-- wp:group {
	"metadata": {
		...
		"patternName": "capsule/mbf-product-carousel",
...
<div class="wp-block-group alignwide" style="margin-top: 0; margin-bottom: 0">
	...
	<div class="wp-block-group alignfull" style="margin-top: 0; margin-bottom: var(--wp--preset--spacing--60)">
		<!-- wp:group {
			"lock": {
				"move": true,
				"remove": true
		...
		<div class="wp-block-group alignwide" style="margin-top: 0; margin-bottom: 0">
			...
			<h2 class="wp-block-heading alignwide has-large-font-size" style="margin-top: 0; margin-bottom: 0">
				<?php echo esc_html__( 'You May Be Interested', 'capsule' ); ?>
			</h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
	...
	<div class="wp-block-group alignfull" style="margin-top: var(--wp--preset--spacing--60); margin-bottom: 0">
