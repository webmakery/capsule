...
<!-- wp:group {
	"metadata": {
		...
		"patternName": "capsule/mbf-about-banner"
	},
	"align": "full",
	"layout": {
		"type": "constrained"
				...
				<div class="wp-block-group alignwide">
					...
					<div class="wp-block-group is-type-mbf-stick-bottom">
						...
						<div class="wp-block-group">
							...
							<p
								class="has-text-align-center has-mbf-secondary-color has-text-color has-link-color has-base-font-family"
							><?php esc_html_e( 'Core pieces upgraded with stronger materials and refined tailoring. Made to perform consistently across seasons.', 'capsule' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->
					</div>
